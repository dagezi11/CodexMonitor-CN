...
export function BranchSwitcherPrompt({
  ...
  return (
    <ModalShell
      ...
      ariaLabel={t("branchSwitcher.ariaLabel")}
    >
      <input
        ref={inputRef}
      ...
      <BranchList
        ...
        emptyText={t("branchSwitcher.noBranches")}
        ...
        renderMeta={(branch) => {
          ...
          return (
            <span className="branch-switcher-modal-item-meta">
              {isCurrent && (
                <span className="branch-switcher-modal-item-current">{t("branchSwitcher.current")}</span>
              )}
              {worktree && (
                <span className="branch-switcher-modal-item-worktree">{t("branchSwitcher.worktree")}</span>
              )}
            </span>
          );
        }}
